...
def get_filters():
    ...
    while True:
        ...
        if city not in cities:
            print('"{}" is currently not a city we have information on. Please try again.'.format(city))
            continue
        else:
            break
    ...
    while True:
        ...
        if month not in months:
            print('"{}" is not a valid month. Please try another month.' .format(month))
            continue
        else:
            break
    ...
    while True:
        ...
        if day not in days:
            print('"{}" is not a valid day. Please choose another day.'.format(day))
            continue
        else:
            break
...
def user_stats(df):
    ...
    print ("The oldest user was born in the year: ", earliest)              
    most_recent = int(df['Birth Year'].max())
    print("The youngest user was born in the year: ", recent)                          
    most_common = int(df['Birth Year'].mode())
    print("Most users were born in: ", most_common) 
